...
from wrf import (to_np,interplevel, getvar, smooth2d, get_basemap,latlon_coords)
...
class WrfPyApp:
    def __init__(self, master):
      ...
      # frame_right.grid(row=0, column=2, padx=2, pady=2)
        ...
        self.emptyDraw()
    def chooseData(self):
        self.path = filedialog.askopenfilename(title="select a file", initialdir="/home")
    def emptyDraw(self):
